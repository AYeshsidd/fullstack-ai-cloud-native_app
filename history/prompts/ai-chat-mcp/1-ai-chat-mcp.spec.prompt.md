...
user: Claude
command: '/sp.specify "# Phase III – Spec 2: AI Chat Endpoint
...
links:
  ...
  pr: null
files:
- D:\Ai_Todo\specs\002-ai-chat-mcp\spec.md
- D:\Ai_Todo\specs\002-ai-chat-mcp\checklists\requirements.md
tests: []
---
...
```
/sp.specify "# Phase III – Spec 2: AI Chat Endpoint
