  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            ...
            <div className="flex items-center">
              {user ? (
                ...
                <div className="flex space-x-3 md:space-x-4">
                  <Link
                    href="/auth/signin"
                    className=" px-1 py-1 md:px-4 md:py-2 text-gray-700 hover:shadow-lg hover:shadow-indigo-400 transition duration-200 md:border md:border-indigo-500 rounded-xl md:rounded-2xl"
                  >
                    Sign In
                  </Link>
                  <Link
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition duration-200 cursor-pointer hover:shadow-indigo-200 hover:transition-transform ">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Who Should Use TodoFlow?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:transition-all hover:cursor-pointer duration-700 ease-in-out hover:-translate-y-1 hover:scale-[1.03] hover:shadow-xl">
