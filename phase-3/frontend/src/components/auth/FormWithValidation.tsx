...
interface AuthFormProps<T extends z.ZodSchema<any>> {
  ...
  onSubmit: (data: any) => void; // We'll refine this type later
  error?: string | null;
  isLoading?: boolean;
...
export const AuthForm = <T extends z.ZodSchema<any>>({
  title,
  subtitle,
  children,
  onSubmit,
        ...
        >
          <div className="p-1 bg-gradient-to-r from-indigo-500 to-cyan-500">
            <div className="bg-white rounded-xl p-8">
              ...
              <form onSubmit={handleSubmit(onSubmitHandler)} className="mt-8 space-y-6">
                {error && (
                  <motion.div
